 ...
 * @extends Certificate
 */
module.exports = class ApprenticeshipCertificate extends ce.Certificate
{
	/**
	...
	{
		super();
		this.setContextAndType("http://schema.eduworks.com/simpleCtdl","ApprenticeshipCertificate");
	}
