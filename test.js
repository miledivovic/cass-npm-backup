...
class EcRsaTest {
    str2ab2strTest = function () {
        console.log("-----str2ab2strTest-----");
        var randomString =
            "\u16a0\u16c7\u16bb\u16eb\u16d2\u16e6\u16a6\u16eb\u16a0\u16b1\u16a9\u16a0\u16a2\u16b1\u16eb\u16a0\u16c1\u16b1\u16aa\u16eb\u16b7\u16d6\u16bb\u16b9\u16e6\u16da\u16b3\u16a2\u16d7";
        Assert.assertTrue(
            EcCrypto.ab2str(EcCrypto.str2ab(randomString)) == randomString
        );
        console.log(forge.util.encodeUtf8(randomString));
        Assert.assertTrue(
            forge.util.decodeUtf8(
                EcCrypto.ab2str(
                    EcCrypto.str2ab(forge.util.encodeUtf8(randomString))
                )
            ) == randomString
        );
    };
    rsaOaepTest = function () {
        ...
        Assert.assertTrue(decrypted.equals(randomString));
        var signature = EcRsaOaep.sign(ppk, randomString);
        Assert.assertTrue(
            EcRsaOaep.verify(ppk.toPk(), randomString, signature)
        );
        var signature = EcRsaOaep.signSha256(ppk, randomString);
        Assert.assertTrue(
            EcRsaOaep.verifySha256(ppk.toPk(), randomString, signature)
        );
    };
    ...
    rsaOaepAsyncNativeTest = async function () {
        console.log("-----rsaOaepAsyncNativeTest-----");
        let randomString = EcAes.newIv(32);
        console.log("Generated string: " + randomString);
        ...
        Assert.assertTrue(
            await EcRsaOaepAsync.verify(ppk.toPk(), randomString, signature)
        );
    ...
    rsaUtf8OaepAsyncNativeTest = async function () {
    ...
    rsaOaepAsyncNativeTestWorker = async function () {
        ...
        let encrypted = await EcRsaOaepAsyncWorker.encrypt(
            ppk.toPk(),
            randomString
        );
        console.log("Encrypted string: " + encrypted);
        ...
        console.log("Sign SHA 256: " + randomString);
        var signature = await EcRsaOaepAsyncWorker.signSha256(
            ppk,
            randomString
        );
        console.log("Verify SHA 256: " + randomString);
        Assert.assertTrue(
            await EcRsaOaepAsyncWorker.verifySha256(
                ppk.toPk(),
                randomString,
                signature
            )
...
class EcAesAsyncTest {
    aesTest = async function () {
        ...
        console.log("Encrypted String: " + encrypted);
        console.log(
            "Encrypted String (Proper): " +
            EcAesCtr.encrypt(randomString, secret, iv)
        );
        Assert.assertTrue(
            encrypted == EcAesCtr.encrypt(randomString, secret, iv)
        );
    ...
    aesCrossTest1Utf8 = function () {
        ...
        EcAesCtrAsync.encrypt(
            ...
            function (encrypted) {
                ...
                console.log("Decrypted String: " + decrypted);
                Assert.assertEquals(
                    "EcAesAsyncTest:aesCrossTest1Utf8",
                    randomString,
                    decrypted
                );
            },
    ...
    aesCrossTest2Utf8 = function () {
        ...
        EcAesCtrAsync.decrypt(
            ...
            function (decrypted) {
                console.log("Decrypted String: " + decrypted);
                Assert.assertEquals(
                    "EcAesAsyncTest:aesCrossTest2Utf8",
                    randomString,
                    decrypted
                );
            },
    ...
    aesTestWorker = async function () {
        ...
        var iv = EcAes.newIv(16);
        console.log("Random iv:" + iv);
        let encrypted = await EcAesCtrAsyncWorker.encrypt(
            randomString,
            secret,
            iv
        );
        ...
        let decrypted = await EcAesCtrAsyncWorker.decrypt(
            encrypted,
            secret,
            iv
        );
    ...
    aesCrossTest1Worker = function () {
        ...
        EcAesCtrAsyncWorker.encrypt(
            ...
            function (encrypted) {
                ...
                console.log("Decrypted String: " + decrypted);
                Assert.assertEquals(
                    "EcAesAsyncTest:aesCrossTest1Worker",
                    randomString,
                    decrypted
                );
            },
    ...
    aesCrossTest1Utf8Worker = function () {
        ...
        EcAesCtrAsyncWorker.encrypt(
            ...
            function (encrypted) {
                ...
                console.log("Decrypted String: " + decrypted);
                Assert.assertEquals(
                    "EcAesAsyncTest:aesCrossTest1Utf8Worker",
                    randomString,
                    decrypted
                );
            },
    ...
    aesCrossTest2Utf8Worker = function () {
        ...
        EcAesCtrAsyncWorker.decrypt(
            ...
            function (decrypted) {
                console.log("Decrypted String: " + decrypted);
                Assert.assertEquals(
                    "EcAesAsyncTest:aesCrossTest2Utf8Worker",
                    randomString,
                    decrypted
                );
            },
...
class EcPpkTest {
    ppkPkKeyTest = function () {
        ...
        Assert.assertTrue(
            "PPK.toPem().fromPem().n == PPK.n",
            "" + ppkToFromPem.ppk.n == "" + ppk.ppk.n
        );
        Assert.assertTrue(
            "PPK.toPem().fromPem().e == PPK.e",
            "" + ppkToFromPem.ppk.e == "" + ppk.ppk.e
        );
        Assert.assertTrue(
            "PPK.toPem().fromPem().d == PPK.d",
            "" + ppkToFromPem.ppk.d == "" + ppk.ppk.d
        );
        Assert.assertTrue(
            "PPK.toPem().fromPem().p == PPK.p",
            "" + ppkToFromPem.ppk.p == "" + ppk.ppk.p
        );
        Assert.assertTrue(
            "PPK.toPem().fromPem().q == PPK.q",
            "" + ppkToFromPem.ppk.q == "" + ppk.ppk.q
        );
        var pkToFromPem = EcPk.fromPem(pk.toPem());
        Assert.assertTrue(
            "PPK.toPk().toPem().fromPem().n == PPK.n",
            "" + pkToFromPem.pk.n == "" + ppk.ppk.n
        );
        Assert.assertTrue(
            "PPK.toPk().toPem().fromPem().e == PPK.e",
            "" + pkToFromPem.pk.e == "" + ppk.ppk.e
        );
    };
}
class EcTaskTest {
...
async function fun() {
    try {
        ...
        obj.rsaUtf8OaepTest();
        obj.str2ab2strTest();
        await obj.rsaOaepAsyncNativeTest();
