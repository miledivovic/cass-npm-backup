...
class EcRsaTest {
    str2ab2strTest = function() {
        ...
        Assert.assertTrue(EcCrypto.ab2str(EcCrypto.str2ab(randomString)) == randomString);
        console.log(forge.util.encodeUtf8(randomString));
        Assert.assertTrue(forge.util.decodeUtf8(EcCrypto.ab2str(EcCrypto.str2ab(forge.util.encodeUtf8(randomString)))) == randomString);
    };
    rsaOaepTest = function() {
        ...
        Assert.assertTrue(EcRsaOaep.verify(ppk.toPk(),randomString,signature));
        var signature = EcRsaOaep.signSha256(ppk,randomString);
        Assert.assertTrue(EcRsaOaep.verifySha256(ppk.toPk(),randomString,signature));
    };
    ...
    rsaOaepAsyncNativeTest = async function() {
        ...
        Assert.assertTrue(await EcRsaOaepAsync.verify(ppk.toPk(),randomString,signature));
        ...
        Assert.assertTrue(await EcRsaOaepAsync.verifySha256(ppk.toPk(),randomString,signature));
    };
