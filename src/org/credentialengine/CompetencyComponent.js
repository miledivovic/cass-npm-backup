/**
 * credentialengine.org/CompetencyComponent
 ...
 */
module.exports = class CompetencyComponent extends ce.PathwayComponent
{
	/**
	...
	{
		super();
		this.setContextAndType("http://schema.eduworks.com/simpleCtdl","CompetencyComponent");
	}
