...
module.exports = class EcEncryptedValue extends EbacEncryptedValue{
    ...
    static fromEncryptedValueAsync(d, success, failure) {
        console.trace("fromEncryptedValueAsync is deprecated. The promise version, fromEncryptedValue, supports promises and callbacks. This will continue to function.");
    ...
    static toEncryptedValue(d, hideType, success, failure) {
        ...
        return this.encryptValueActual(v,d.toJson(),newIv,newSecret,d.id,d.owner,d.reader,success,failure);
    };
    /**
     *  Converts a piece of remote linked data to an encrypted value,
     *  asynchronously
    ...
    static toEncryptedValueAsync(d, hideType, success, failure) {
        console.trace("toEncryptedValueAsync is deprecated. The promise version, fromEncryptedValue, supports promises and callbacks. This will continue to function.");
    ...
    static encryptValueOld(text, id, owner) {
        var newIv = EcAes.newIv(16);
        var newSecret = EcAes.newIv(16);
        return this.encryptValueActual(new EcEncryptedValue(),text,newIv,newSecret,id,[owner],null,null,null);
    };
    /**
    ...
    static encryptValueUsingIvAndSecret(iv, secret, text, id, owners, readers) {
        return this.encryptValueActual(v,text,iv,secret,id,owners,readers,null,null);
    };
    /**
