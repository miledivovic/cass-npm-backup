...
module.exports = class Graph extends Hypergraph {
	 ...
	 */
	isPredecessor(v1, v2) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 *  @method isSuccessor
	 */
	isSuccessor(v1, v2) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 */
	getPredecessorCount(vertex) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 */
	getSuccessorCount(vertex) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 *  @method isSource
	 */
	isSource(vertex, edge) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 */
	isDest(vertex, edge) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 */
	addEdge(e, v1, v2) { } //NOSONAR -- Method is intended to be abstract
	/**
	 ...
	 *  @method getOpposite
	 */
	getOpposite(vertex, edge) { } //NOSONAR -- Method is intended to be abstract
};
