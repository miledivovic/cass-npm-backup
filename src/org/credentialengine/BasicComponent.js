/**
 * credentialengine.org/BasicComponent
 ...
 */
module.exports = class BasicComponent extends ce.PathwayComponent
{
	/**
	...
	{
		super();
		this.setContextAndType("http://schema.eduworks.com/simpleCtdl","BasicComponent");
	}
