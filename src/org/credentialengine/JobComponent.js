/**
 * credentialengine.org/JobComponent
 ...
 */
module.exports = class JobComponent extends ce.PathwayComponent
{
	/**
	...
	{
		super();
		this.setContextAndType("http://schema.eduworks.com/simpleCtdl","JobComponent");
	}
