/**
 * credentialengine.org/AssessmentComponent
 ...
 */
module.exports = class AssessmentComponent extends ce.PathwayComponent
{
	/**
	...
	{
		super();
		this.setContextAndType("http://schema.eduworks.com/simpleCtdl","AssessmentComponent");
	}
