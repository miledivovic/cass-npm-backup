 ...
 * @extends Credential
 */
module.exports = class QualityAssuranceCredential extends ce.Credential
{
	/**
	...
	{
		super();
		this.setContextAndType("http://schema.eduworks.com/simpleCtdl","QualityAssuranceCredential");
	}
